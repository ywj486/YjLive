...
import com.ywj.yjlive.http.OkHttpHelper;
import com.ywj.yjlive.http.SpotsCallBack;
    ...
    private  void initRefreshLayout(){
        ...
        this.refreshLayout.setMaterialRefreshListener(new MaterialRefreshListener() {
            ...
            public void onRefreshLoadMore(MaterialRefreshLayout materialRefreshLayout) {
                Log.e("LYM_TAG", "pageIndex="+pageIndex+"totalPage="+totalPage);
